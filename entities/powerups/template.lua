...
function module.spawn(ship_id, x, y, mesh, icon_mesh, text, color, callback)
  ...
  entity_set_radius(box, 22fx)  -- [TODO: make this global in config?]
  ...
  entity_set_radius(inner_box, 22fx)  -- [TODO: make this global in config?]

  function box_player_collision(entity_id, player_id, ship_id)
    x, y = entity_get_pos(ship_id)
    pu = fm.new(x, y, text, 1fx, color, 16)  -- [TODO: make this global in config?]
